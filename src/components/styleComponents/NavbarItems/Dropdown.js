...
import { Button, IconButton, Menu, MenuButton, MenuDivider, MenuGroup, MenuItem, MenuList, useColorMode } from '@chakra-ui/react'
...
//       const { data } = useUser();
  ...
  return (
    <div>
        <Menu>
  <MenuButton as={IconButton} icon={<FiSliders/>} color={buttonColor} variant="ghost">
    Profile
  </MenuButton>
  <MenuList>
