  ...
  return (
    <Box height="100%" width="100%" overflow="auto" display="flex" justifyContent="center" alignItems="center">
      {data !== null && data.length > 0 ? (
        <div>
          <Text textAlign="center" color='gray.400'> Latest Transactions</Text>
...
const Dashboard = () => {
  ...
  const latestImage = colorMode === 'dark' ? 'fittingDark.png' : 'fittingLight.png';
  return (
    <>
      {isSmallerScreen ? (
        ...
        <Grid templateRows="repeat(2, 1fr)" gap={4} minW="100%" maxH="100vh">
          <Grid templateColumns="repeat(3, 1fr)" gap={4}>
            ...
            <Box p={4} justifyContent="center" alignItems="center" alignSelf="stretch">
              <VStack>
